...
- (void)setModelWithData:(PersonIndentModel *)model{
    ...
    [self insertObject:model.isUseCoupon toDic:dic andKey:@"isUseCoupon"];
    [self insertObject:model.couponPrice toDic:dic andKey:@"couponPrice"];
    [self insertObject:model.origialPrice toDic:dic andKey:@"origialPrice"];
...
- (PersonIndentModel *)getPersonIndentModel{
    ...
    if (dic) {
        ...
        model.desribeStr = [dic objectForKey:@"isUseCoupon"];
        model.desribeStr = [dic objectForKey:@"couponPrice"];
        model.desribeStr = [dic objectForKey:@"origialPrice"];
