...
- (void)loadPostDataWithUrl:(NSString *)urlStr andDic:(NSDictionary *)dic andSuccessBlock:(void (^)(NSArray *))successBlock andDicFiledResonBlock:(void (^)(NSObject *))failedBlock{
